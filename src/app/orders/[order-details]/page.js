    ...
    return ( <div className="py-14 px-4 md:px-6">
        <div className="flex justify-start items-start space-y-2 flex-col">
           ...
           <p className="text-base font-medium leading-6 text-gray-600">
                {orderDetails && orderDetails.createdAt && orderDetails.createdAt.split('T')[0]}{" "} | {orderDetails && orderDetails.createdAt && orderDetails.createdAt.split('T')[1].split('.')[0]}
                    ...
                    <div className="flex flex-col px-4 py-6 md:p-6 w-full bg-gray-50 space-y-6">
                        ...
                        <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                            <div className="flex justify-between w-full">
                                ...
                                <p className="text-base leading-5 text-gray-500">${orderDetails && orderDetails.totalPrice}</p>
                ...
                <div className="flex flex-col gap-5">
                    <div className="bg-gray-50 w-full xl:w-96 flex items-center md:items-start px-4 py-6 flex-col">
                        ...
                        <div className="flex flex-col justify-start items-start flex-shrink-0">
                            <div className="flex gap-4 justify-center flex-col w-full md:justify-start space-x-4 py-8 border-b border-gray-200">
                    ...
                    <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                        <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 md:space-y-4 xl:space-y-12 md:flex-row items-center md:items-start">
                    ...
                    <button onClick={()=>router.push(`/`)} className="mt-5 mr-5 inline-block bg-black text-white px-5">
                        Shop Again
                    </button>
